			...
			case 'SetLocations':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{locations: _p10}),
					_1: _user$project$App$outgoingLocations(_p10)
				};
			case 'SetError':
				return {
					ctor: '_Tuple2',
...
var _user$project$App$dateFilter = function (_p11) {
	var _p12 = _p11;
	var options = A2(
		_elm_lang$core$List$map,
		function (date) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_Utils.eq(date, _p12.dateFilter))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
		...
		_user$project$App$uniqueLocationDates(_p12.locations));
	return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_user$project$App$dateFilter(model)
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
...
var _user$project$App$getLocations = A3(
...
var _user$project$App$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$App$model, _1: _user$project$App$getLocations},
