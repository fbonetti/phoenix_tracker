...
var _user$project$App$toText = function (_p0) {
	return _elm_lang$html$Html$text(
		_elm_lang$core$Basics$toString(_p0));
};
var _user$project$App$dateToIso = _mgold$elm_date_format$Date_Format$format('%Y-%m-%d');
var _user$project$App$unixToDate = function (_p1) {
...
var _user$project$App$uniqueLocationDates = function (locations) {
	return _elm_lang$core$List$reverse(
		_elm_lang$core$Set$toList(
			_elm_lang$core$Set$fromList(
				A2(
					...
					function (location) {
						return function (_p2) {
							return _user$project$App$dateToIso(
								_user$project$App$unixToDate(_p2));
						}(location.recordedAt);
					},
					locations))));
};
var _user$project$App$renderLocation = function (location) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$App$toText(location.id)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$App$toText(location.latitude)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$App$toText(location.longitude)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						function (_p3) {
						return _user$project$App$toText(
							_user$project$App$unixToDate(_p3));
					}(location.recordedAt)
					])),
				A2(
				_elm_lang$html$Html$td,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(location.batteryState)
					]))
			]));
};
var _user$project$App$renderLocations = function (locations) {
	return A2(
		_elm_lang$html$Html$table,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('table table-sm')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Timestamp')
							])),
						A2(
						_elm_lang$html$Html$th,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Battery')
							]))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$App$renderLocation, locations))
			]));
};
var _user$project$App$filteredLocations = function (_p4) {
	var _p5 = _p4;
	var _p8 = _p5.locations;
	var _p7 = _p5.dateFilter;
	return _elm_lang$core$Native_Utils.eq(_p7, '') ? _p8 : A2(
		_elm_lang$core$List$filter,
		function (location) {
			return _elm_lang$core$Native_Utils.eq(
				function (_p6) {
					return _user$project$App$dateToIso(
						_user$project$App$unixToDate(_p6));
				}(location.recordedAt),
				_p7);
		},
		_p8);
...
var _user$project$App$model = {
	locations: _elm_lang$core$Native_List.fromArray(
		[]),
	error: '',
	dateFilter: ''
};
...
var _user$project$App$outgoingLocations = _elm_lang$core$Native_Platform.outgoingPort(
	'outgoingLocations',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {id: v.id, latitude: v.latitude, longitude: v.longitude, recordedAt: v.recordedAt, batteryState: v.batteryState};
			});
	});
		...
		switch (_p9.ctor) {
			case 'SetLocations':
				var model$ = _elm_lang$core$Native_Utils.update(
					model,
					{locations: _p9._0});
				var cmd = function (_p10) {
					return _user$project$App$outgoingLocations(
						_user$project$App$filteredLocations(_p10));
				}(model$);
			...
			case 'SetDateFilter':
				var model$ = _elm_lang$core$Native_Utils.update(
					model,
					{dateFilter: _p9._0});
				var cmd = function (_p11) {
					return _user$project$App$outgoingLocations(
						_user$project$App$filteredLocations(_p11));
				}(model$);
				return {ctor: '_Tuple2', _0: model$, _1: cmd};
			default:
...
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {locations: a, error: b, dateFilter: c};
	});
var _user$project$App$Location = F5(
	function (a, b, c, d, e) {
		return {id: a, latitude: b, longitude: c, recordedAt: d, batteryState: e};
	});
var _user$project$App$locationDecoder = A6(
	_elm_lang$core$Json_Decode$object5,
	_user$project$App$Location,
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'recorded_at', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'battery_state', _elm_lang$core$Json_Decode$string));
var _user$project$App$locationsDecoder = _elm_lang$core$Json_Decode$list(_user$project$App$locationDecoder);
var _user$project$App$NoOp = {ctor: 'NoOp'};
var _user$project$App$SetDateFilter = function (a) {
	return {ctor: 'SetDateFilter', _0: a};
};
var _user$project$App$renderDateFilter = function (_p12) {
	var _p13 = _p12;
	var options = A2(
		_elm_lang$core$List$map,
		function (date) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(date),
						_elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(date, _p13.dateFilter))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
		...
		_user$project$App$uniqueLocationDates(_p13.locations));
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$App$SetDateFilter)
					]),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Show all')
								]))
						]),
					options))
			]));
...
var _user$project$App$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('row full-height')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-sm-6 display-flex flex-direction-column')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Locations')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_user$project$App$renderDateFilter(model)
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('flex-1 overflow-y-scroll')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$App$renderLocations(
								_user$project$App$filteredLocations(model))
							]))
					]))
			]));
};
var _user$project$App$SetError = function (a) {
	return {ctor: 'SetError', _0: a};
};
var _user$project$App$SetLocations = function (a) {
	return {ctor: 'SetLocations', _0: a};
};
var _user$project$App$fetchLocations = A3(
	_elm_lang$core$Task$perform,
	_user$project$App$SetError,
	_user$project$App$SetLocations,
	A2(_evancz$elm_http$Http$get, _user$project$App$locationsDecoder, '/api/locations'));
var _user$project$App$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$App$model, _1: _user$project$App$fetchLocations},
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Array", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Basics", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Bitwise", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Char", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Color", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Date", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Debug", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Dict", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Json/Decode", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Json/Encode", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/List", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Maybe", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Array", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Basics", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Bitwise", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Char", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Date", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Debug", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Json", function(exports, require, module) {
'use strict';
	...
	function badToString(problem) {
		...
		while (problem) {
			switch (problem.tag) {
				...
				case 'custom':
					return 'A `customDecode` failed' + (context === '_' ? '' : ' at ' + context) + ' with the message: ' + problem.msg;
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/List", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Platform", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Regex", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Scheduler", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/String", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Time", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Native/Utils", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Platform", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Platform/Cmd", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Platform/Sub", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Process", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Random", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Regex", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Result", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Set", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/String", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Task", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/src/Time", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Array", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Basics", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Bitwise", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Char", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/CodeGen", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Dict", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Equality", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Json", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/List", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Regex", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Result", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/Set", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.3/tests/Test/String", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.1.0/src/Html", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.1.0/src/Html/App", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.1.0/src/Html/Attributes", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.1.0/src/Html/Events", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.1.0/src/Html/Keyed", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/html/1.1.0/src/Html/Lazy", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.0/src/Native/VirtualDom", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.0/src/VirtualDom", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.0/tests/Native/TestHelpers", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.0/tests/TestCases/Lazy", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.0/tests/TestHelpers", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.0/tests/TestMain", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-http/3.0.1/src/Blob", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-http/3.0.1/src/Http", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/evancz/elm-http/3.0.1/src/Native/Http", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/mgold/elm-date-format/1.1.4/src/Date/Format", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/mgold/elm-date-format/1.1.4/tests/test", function(exports, require, module) {

});

;require.register("web/elm/src/Main", function(exports, require, module) {
